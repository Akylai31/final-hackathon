      ...
      {detailsData ? (
        <div>
          ...
          >
            ...
            <div className="details_product_card">
              <div className="details_product_card_title">
                {detailsData.title}
              </div>
              <div>{detailsData.color}</div>
              <div className="details_product_card_price">
                {" "}
                $ {detailsData.price}
              </div>
              <div>
                {" "}
                <IconButton
                  color={checkLikes() ? "secondary" : ""}
                  id="btn_like"
                  onClick={() => likes()}
                >
                  <FavoriteIcon />
                  {detailsData.likes.length}
                </IconButton>
                <IconButton
                ...
                <IconButton
                  onClick={() => addProductToCart(detailsData)}
                  color={checkProductInCart(detailsData.id) ? "secondary" : ""}
                >
                  <LocalMallIcon />
                </IconButton>
                <br />
          ...
          <div className="details_product_desc">
            <div className="details_product_desc_item">
              DESCRIPTION <br />
              <br />
              {detailsData.desc1}
            </div>
